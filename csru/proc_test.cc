...
TEST(Proc_EvalTest2){
  // " {|a| a }(Class) "
  BasicObjectPtr ref = RefExpression::New(NULL,SRUString::New(symbol("a")));
  vector<symbol> varg;
  ...
  expressions.push_back(ref);
  BasicObjectPtr proc = ProcExpression::New(varg,retval,expressions);
  BasicObjectPtr ref2 = RefExpression::New(NULL,SRUString::New(sym::Class()));
  ptr_vector arg;
  arg.push_back(ref2);
  BasicObjectPtr call = CallExpression::New(proc,arg);
  LOG << InspectAST(call);
...
TEST(Proc_EvalTest3){
  ...
  // let <= a = Class
  BasicObjectPtr ref = RefExpression::New(NULL,SRUString::New(sym::Class()));
  BasicObjectPtr let = LetExpression::New(NULL,SRUString::New(symbol("a")),ref);
  // proc <= {a}
  BasicObjectPtr ref2 = RefExpression::New(NULL,SRUString::New(symbol("a")));
  vector<symbol> varg;
  symbol retval("");
  ptr_vector expressions;
